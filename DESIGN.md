...
>
> ⚠️ ЗНАЧЕНИЯ токенов (цвета, шрифты, радиусы) с 2026-07-15 живут в пакете
> `@24clima/design` (репо 24clima-design, общий с shop.24clima.com) — при
> расхождении значений источник правды: `node_modules/@24clima/design/tokens.css`.
