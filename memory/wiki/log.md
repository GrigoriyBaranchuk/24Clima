...
`sources/2026-08-26-portable-ac-research` (новая), обратные ссылки в
`concepts/tienda-shop`, `concepts/hvac-customer-segments`,
`concepts/service-pricing`; 4 сырых отчёта в `raw/research/2026-08-26-*`.

Суть: идея владельца — продажа + аренда + подменные портативники к цели
$10k/мес. Спрос подтверждён (DataForSEO: 2 900/мес, +132% г/г, CPC $0.35),
аренда — пустая ниша без поискового спроса, налоги 8415.82 = DAI 15% +
ITBMS 7%, каналы: ZLC (быстрый тест) vs прямой контейнер (маржа, к марту);
Русклимат как поставщик — слабый вариант (OEM, нет 60Гц, комплаенс).
Критичная грабля: Панама 120В/60Гц, версии СНГ 220В/50Гц не подходят.
Решения о запуске НЕ приняты — разведка.
