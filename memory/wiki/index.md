...
Обновлено: 2026-09-17 · страниц: 30
...
| Страница | О чём |
|---|---|
| [Система SEO/GEO-мониторинга](concepts/seo-monitoring-system.md) | таблицы `seo_*`, синки (daily vs weekly), пороги свежести, семантика `>20`/`—`, дашборд, цикл рекомендаций и засечки |
...
| [Мобильная версия app-like](concepts/mobile-app-like.md) | решения редизайна, performance overhaul 04.2026 и второй проход 09.2026 (шрифты по поддеревьям, словарь клиенту, ленивое меню, отложенный префетч) |
...
| [QR-наклейка на авто и /qr](concepts/qr-car-sticker.md) | наклейка на стекло RX350, роут /qr → WhatsApp через after(), таблица qr_scans, правила печати QR на микроперфорации |
...
| Страница | О чём |
|---|---|
| [Грабли проекта](synthesis/gotchas.md) | 40 ошибок, которые уже стоили времени — просмотреть перед работой |
