...
**Осталось**
- Ветка `worktree-header-active-nav`, коммит `961e249`. **Push и PR ждут
  явного ok владельца** (правило: код пушится только по «ok/push/go»).
