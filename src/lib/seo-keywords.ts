...
/** Ключевые слова для главной страницы по локалям (5–7 фраз) */
...
> = {
  ...
  hiddenAc: {
    es: [
      ...
      "ductos de aire acondicionado Panamá",
      "aire acondicionado central Panamá",
    ...
    en: [
      "ducted air conditioning Panama",
