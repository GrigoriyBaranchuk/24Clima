        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "24clima",
              description: "Servicio profesional de aire acondicionado en Panamá: instalación, mantenimiento, limpieza profunda, reparación y carga de gas refrigerante. Atención 24/7 en Ciudad de Panamá, Costa del Este, Punta Pacífica, Arraiján, La Chorrera y Panamá Oeste.",
