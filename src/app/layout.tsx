// Токены дизайн-системы (@24clima/design/tokens.css) больше не импортируются
// здесь отдельно: они подключены через @import первой строкой globals.css.
// Порядок «токены строго перед локальными стилями» (требование README пакета)
// сохранён внутри одного файла — и это на один блокирующий CSS-запрос меньше.
import "./globals.css";
