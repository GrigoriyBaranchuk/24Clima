...
/**
 * Desktop-only price calculator (full panel with breakdown, savings, CTA).
 * Loaded only on non-mobile UA via Calculator (server orchestrator).
 */
        ...
        <div className="w-full max-w-2xl mx-auto">
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20 rounded-xl">
            <CardContent className="p-8">
                ...
                <div className="flex items-center justify-center gap-3 flex-wrap">
                  ...
                  <div className="flex items-center bg-white/10 rounded-xl overflow-hidden">
                    <button
                      type="button"
                      onClick={decrement}
                      className="w-12 h-12 flex items-center justify-center text-white hover:bg-white/20 transition-all active:scale-90"
              ...
              {/* Package Selection */}
              <div className="mb-6">
                <label className="block text-white font-medium mb-3">{t("package")}</label>
                <div className="grid grid-cols-3 gap-2">
                  {(["basic", "recommended", "premium"] as PackageType[]).map((pkg) => (
                    <button
                      ...
                      className={`min-w-0 py-3 px-2 rounded-xl font-medium text-sm text-center transition-all active:scale-95 flex flex-col items-center justify-center gap-0.5 ${
                        packageType === pkg
                    ...
                    >
                      ...
                      {pkg === "recommended" && <span className="text-sm opacity-80 shrink-0">★</span>}
                    </button>
                  ))}
                </div>
              </div>
