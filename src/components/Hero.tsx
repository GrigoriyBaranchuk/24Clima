        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {/* Mobile: Primary CTA — "Cotizar Ahora" with entrance animation */}
              <Button
                asChild
                size="lg"
                className="sm:hidden bg-gradient-to-r from-[#7BC043] to-[#5fa832] hover:from-[#6aaf38] hover:to-[#4e9628] text-white font-bold text-lg px-8 py-7 shadow-lg shadow-[#7BC043]/30 cta-hero-animate"
              >
                <a href="#calculadora">
              ...
              {/* Desktop: WhatsApp CTA (unchanged) */}
              <Button
                asChild
                size="lg"
                className="hidden sm:inline-flex bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold text-lg px-8 py-6 whatsapp-pulse"
              >
                <a
              ...
              {/* Desktop: Secondary CTA — "Cotizar ahora" */}
              <Button
                asChild
                size="lg"
                variant="outline"
                className="hidden sm:inline-flex border-white text-white hover:bg-white hover:text-[#1e3a5f] font-semibold text-lg px-8 py-6 bg-[#7BC043]/20"
              >
                <a href="#calculadora">
                  {tCommon("viewServices")}
                </a>
