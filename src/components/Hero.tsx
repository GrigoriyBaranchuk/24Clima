...
export default async function Hero() {
  ...
  return (
    <section className="relative lg:min-h-[100vh] flex items-center bg-[#0d1b2a] lg:bg-transparent hero-gradient overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Badge className="hidden lg:inline-flex bg-white/20 text-white border-white/30 mb-6 py-2 px-4 text-sm backdrop-blur-sm">
            ...
            {/* Tagline — hidden on mobile to keep hero compact */}
            <p className="hidden lg:block text-xl text-white/90 mb-8 max-w-xl leading-relaxed">
              {t("tagline")}
            </p>

            {/* Geo Line — hidden on mobile */}
            <p className="hidden lg:block text-base text-white/70 mb-6">
              {tCommon("geoLine")}
            </p>

            {/* CTA Buttons — Mobile: row with WhatsApp + Nosotros */}
        ...
        <div className="hidden lg:grid grid-cols-3 gap-8 mt-16 pt-8 border-t border-white/20">
          ...
          <div className="text-left">
            <p className="text-4xl font-bold text-[#7BC043]" style={{ fontVariantNumeric: "tabular-nums" }}>{t("stat2Value")}</p>
