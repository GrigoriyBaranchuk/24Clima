...
export default function NosotrosCTA() {
  const t = useTranslations("nosotrosCta");
      ...
      <div className="container mx-auto px-4 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-white text-white hover:bg-white hover:text-[#1e3a5f] font-semibold text-lg px-8 py-6"
          >
            <a href="tel:+50768282120">
