...
import { Wrench, Wind, Thermometer, Droplets, Settings, Zap, ChevronRight } from "lucide-react";
...
const SERVICES: ServiceItem[] = [
  { slug: "limpieza",     translationKey: "cleaning",    icon: Droplets,   gradient: "from-[#4A90D9] to-[#357ABD]" },
  { slug: "mantenimiento",translationKey: "maintenance", icon: Settings,   gradient: "from-[#7BC043] to-[#0F9D58]" },
  { slug: "reparacion",   translationKey: "repair",      icon: Wrench,     gradient: "from-[#F5A623] to-[#E8961E]" },
  { slug: "instalacion",  translationKey: "installation",icon: Wind,       gradient: "from-[#185FA5] to-[#103E6E]" },
  { slug: "carga-de-gas", translationKey: "gasRecharge", icon: Thermometer,gradient: "from-[#0F6E56] to-[#0a4f3e]" },
  { slug: "emergencia",   translationKey: "emergency",   icon: Zap,        gradient: "from-[#E55B8C] to-[#A32D2D]" },
];
  ...
  return (
    <section className="lg:hidden bg-[#0d1b2a] px-4 pt-4 pb-6 min-h-[calc(100dvh-3.5rem-5rem)]">
      ...
      <div className="mb-4">
        ...
        <h1 className="text-white text-[22px] font-semibold mt-1" style={{ letterSpacing: "-0.3px" }}>
          {t("subtitle")}
        </h1>
      </div>
          ...
          return (
            <li key={s.slug}>
              ...
              >
                ...
                <ChevronRight className="w-5 h-5 text-white/40 shrink-0" aria-hidden="true" />
              </Link>
            </li>
          );
        })}
