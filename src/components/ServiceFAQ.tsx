...
export default function ServiceFAQ({ translationKey, pageUrl }: ServiceFAQProps) {
  ...
  return (
    <>
      ...
      />
      <section className="py-16 lg:py-24 section-gradient" aria-labelledby="faq-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 id="faq-heading" className="text-2xl sm:text-3xl font-bold text-[#1e3a5f] text-center mb-10">
            {t("faqSectionTitle")}
          </h2>
