      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-8">
          <div className="bg-gradient-to-br from-[#1e3a5f] to-[#0d2240] rounded-2xl p-5 lg:p-10 text-white">
            <h3 className="text-lg lg:text-2xl font-semibold mb-2 lg:mb-3">{t("nosotrosTitle")}</h3>
            <p className="text-white/80 text-[13px] lg:text-base mb-4 lg:mb-6">{t("nosotrosText")}</p>
          ...
          <div className="bg-gradient-to-br from-[#0F9D58] to-[#128C7E] rounded-2xl p-5 lg:p-10 text-white">
            <h3 className="text-lg lg:text-2xl font-semibold mb-2 lg:mb-3">{t("contactoTitle")}</h3>
            <p className="text-white/90 text-[13px] lg:text-base mb-4 lg:mb-6">{t("contactoText")}</p>
