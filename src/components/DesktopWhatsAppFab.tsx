...
export default function DesktopWhatsAppFab() {
  ...
  return (
    <a
      ...
      className={[
        "hidden lg:flex fixed bottom-6 right-6 z-40 items-center justify-center",
        "w-[60px] h-[60px] rounded-full bg-[#25D366] text-white",
        "shadow-[0_8px_24px_rgba(37,211,102,0.4)]",
        "transition-[transform,opacity,box-shadow] duration-220 ease-out-emil",
        "hover:scale-[1.06] hover:shadow-[0_12px_32px_rgba(37,211,102,0.55)]",
        "active:scale-[0.95]",
