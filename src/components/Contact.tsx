  ...
  const contactMethods = [
    {
      ...
      description: t("immediateResponse"),
      action: getWhatsAppLink(tWhatsapp("general")),
      primary: true,
    },
    {
      icon: Phone,
    ...
    },
    {
      ...
      description: t("metropolitanCoverage"),
      action: "#zonas",
      primary: false,
    },
  ];
          ...
          <div className="hidden lg:block">
            <div className="relative h-[250px] rounded-2xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Modern living room with air conditioning"
                fill
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {contactMethods.map((method, index) => (
            <a
              ...
              className="block"
              onClick={() => method.primary && metaPixelEvent("Lead")}
            >
