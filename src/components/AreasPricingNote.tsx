...
const TEXT: Record<SupportedLocale, string> = {
  es: `Los precios son los mismos en todas las zonas de cobertura: limpieza profunda desde $${p.limpieza.minPrice} por split, mantenimiento desde $${p.mantenimiento.minPrice}, reparación desde $${p.reparacion.minPrice}, recarga de gas desde $${p["carga-de-gas"].minPrice} e instalación back-to-back $${p.instalacion.minPrice}. Tiempo de llegada: Costa del Este y Punta Pacífica en menos de 1.5 horas, centro de Ciudad de Panamá en menos de 2 horas, Panamá Oeste según la zona.`,
  en: `Prices are the same in every coverage area: deep cleaning from $${p.limpieza.minPrice} per split, maintenance from $${p.mantenimiento.minPrice}, repair from $${p.reparacion.minPrice}, gas recharge from $${p["carga-de-gas"].minPrice}, and back-to-back installation $${p.instalacion.minPrice}. Arrival time: Costa del Este and Punta Pacífica in under 1.5 hours, downtown Panama City in under 2 hours, Panamá Oeste depending on the area.`,
