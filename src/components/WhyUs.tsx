...
import { Award, Clock, Headphones, MapPin, Shield, Users } from "lucide-react";
...
export default function WhyUs() {
  ...
  return (
    <section
      id="nosotros"
      className="py-20 lg:py-28 bg-[#1e3a5f] relative overflow-hidden scroll-mt-20"
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-white/20">
          <div className="text-center">
            <CountUp
              value="+800"
              className="block text-4xl md:text-5xl font-bold text-[#7BC043] mb-2"
            />
